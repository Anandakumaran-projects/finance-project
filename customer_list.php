...
$sql = "SELECT * FROM customer LIMIT $starting_limit, $results_per_page";
$result = $conn->query($sql);
?>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="cardtable" style="width: 18rem;">
                        <div class="card-bodytable">
                            ...
                            <p class="card-texttable">Email:&nbsp;' . htmlspecialchars($row["email"]) . '<br>
                            Phone Number:&nbsp;' . htmlspecialchars($row["phonenumber"]) . '<br>
                            Address1:&nbsp;' . htmlspecialchars($row["address1"]) . '<br>
                            Address2:&nbsp;' . htmlspecialchars($row["address2"]) . '<br>
