...
$sql = "SELECT * FROM account LIMIT $starting_limit, $results_per_page";
$result = $conn->query($sql);
?>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="cardtable" style="width: 18rem;">
                        <div class="card-bodytable">
                            <h5 class="card-titletable">CustomerId:&nbsp;' . htmlspecialchars($row["customerid"]) . '<br>Accountid:&nbsp;' . htmlspecialchars($row["accountid"]) . '</h5>
